...
const data = {
  ...
  company: {
    ...
    logo: 'https://www.loremfaces.net/256/id/1.jpg',
  },
};
const socialLinks = [
  { icon: Heart, label: 'Facebook', href: data.facebookLink },
  { icon: Building2, label: 'Instagram', href: data.instaLink },
  { icon: Lightbulb, label: 'Twitter', href: data.twitterLink },
];
const aboutLinks = [
...
const contactInfo = [
  { icon: Heart, text: data.contact.email },
  { icon: Building2, text: data.contact.phone },
  { icon: Lightbulb, text: data.contact.address, isAddress: true },
];
