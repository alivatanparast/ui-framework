...
// --- Sub-Components ---
const TestimonialColumnItem = (props: {
  className?: string;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <TestimonialColumnItem testimonials={firstColumn} duration={15} />
          <TestimonialColumnItem testimonials={secondColumn} className="hidden md:block" duration={19} />
          <TestimonialColumnItem testimonials={thirdColumn} className="hidden lg:block" duration={17} />
        </div>
      </motion.div>
    </section>
  );
